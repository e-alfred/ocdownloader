                              ...
                              if (!is_null ($Status))
                              {
                                    if (!isset ($Status['error']))
                                    {
                                          ...
                                          $Queue[] = Array (
                                                ...
                                                'PROGRESS' => Tools::GetProgressString ($Status['result']['completedLength'], $Status['result']['totalLength']) . (isset ($Status['result']['numSeeders']) && $Progress < 1 ? ' - ' . $this->L10N->t ('Seeders') . ': ' . $Status['result']['numSeeders'] : (isset ($Status['result']['numSeeders']) && $Progress == 1 ? ' - ' . $this->L10N->t ('Uploaded') . ': ' . Tools::FormatSizeUnits ($Status['result']['uploadLength']) : '')),
