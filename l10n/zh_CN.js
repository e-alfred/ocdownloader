OC.L10N.register(
    ...
    "Error while checking application version on GitHub" : "在GitHub上检查应用版本时出错",
    "You are not allowed to check for application updates" : "您无权检查应用更新",
    ...
    "Easy to use download manager using Curl/Aria2 and youtube-dl to allow downloading HTTP(S), FTP(S), YouTube videos and BitTorrent files. For more information on how to install, please go to https://github.com/e-alfred/ocdownloader/blob/master/README.md" : "易用的下载管理器，使用Curl/Aria2和youtube-dl工具来下载HTTP(S)、FTP(S)、YouTube视频和BitTorrent文件。关于如何安装的更多信息，请访问 https://github.com/e-alfred/ocdownloader/blob/master/README.md",
    ...
    "Allow HTTP ?" : "允许HTTP？",
    "Allow FTP ?" : "允许FTP？",
    "Allow YouTube ?" : "允许YouTube？",
    "Allow BitTorrent ?" : "允许BitTorrent？",
