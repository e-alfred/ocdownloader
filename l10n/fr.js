OC.L10N.register(
    ...
    "Invalid Aria address URL" : "Adresse Aria invalide",
    "Aria port should be a numeric value" : "Le port du service Aria doit être une valeur numérique",
    "Aria port should be a value from 1 to 65536" : "Le port du service Aria doit être une valeur comprise entre 1 et 65536",
    ...
    "Unable to find download status file %s" : "Impossible de trouver le fichier %s indiquant l'état du téléchargement",
    ...
    "No downloads in the queue…" : "Pas de téléchargement dans la queue …",
    "Paused" : "En pause",
    "Active" : "Actif",
    ...
    " using <strong>%s</strong>" : "utilisant <strong>%s</strong>",
    ...
    "New Magnet/HTTP download" : "Nouveau téléchargement de Magnet/HTTP",
    "New HTTP download" : "Nouveau téléchargement HTTP",
    "Launch Magnet/HTTP download" : "Lancer le téléchargement du Magnet/HTTP",
    "Launch HTTP download" : "Lancer le téléchargement HTTP",
    "Magnet/HTTP link to download" : "Lien Magnet/HTTP à télécharger",
    "HTTP link to download" : "Lien http pour télécharger",
    "Options" : "Options",
    "Basic Auth User" : "Authentification utilisateur basic",
    "Username" : "Identifiant",
    "Basic Auth Password" : "Authentification mot de passe basic",
    "Password" : "Mot de passe",
    "HTTP Referer" : "Référent HTTP",
    "Referer" : "Référent",
    "HTTP User Agent" : "Agent utilisateur HTTP",
    "Useragent" : "Useragent",
    "HTTP Output Filename" : "Nom HTTP du fichier de sortie",
    "Filename" : "Nom du fichier",
    ...
    "FTP Referer" : "Référent FTP",
    "FTP User Agent" : "Agent utilisateur FTP",
    "FTP Output Filename" : "Nom FTP du fichier de sortie",
    ...
    "YouTube Video URL to download" : "Adresse de la vidéo YouTube à télécharger",
    ...
    "Leave fields blank to reset a setting value" : "Laisser les champs vide pour réinitialiser la valeur",
    "YouTube DL Binary Path" : "Chemin vers le binaire de YouTube DL",
    "YouTube DL Audio Format" : "Format audio pour Youtube DL",
    "YouTube DL Video Format" : "Format vidéo pour Youtube DL",
    ...
    "Only use proxy settings with YouTube-DL?" : "Utiliser uniquement les paramètres du proxy pour YouTube-DL ?",
    "No" : "Non",
    "Yes" : "Oui",
    ...
    "ARIA2 Address" : "Adresse Aria 2",
    "ARIA2 Port" : "Port Aria 2",
    "ARIA2 Secret Token" : "Jeton secret Aria 2",
